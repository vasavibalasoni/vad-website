...
# Your model classes remain the same...
...
with col1:
    # Upload section with beautiful design and MORE SPACING
    st.markdown('<div class="spacing-top"></div>', unsafe_allow_html=True)
    
    st.markdown("""
    <div class="upload-box">
        <div style="font-size: 4em; margin-bottom: 20px; color: #FFD166;" class="floating">📁</div>
        <h2 style="color: white; margin-bottom: 10px;">Drop Your Audio Here</h2>
        <p style="color: rgba(255,255,255,0.8); font-size: 1.1em;">Drag and drop your audio file or click below to browse</p>
        <div style="margin-top: 30px; font-size: 2em; color: #06D6A0; animation: float 3s ease-in-out infinite;">⬆️</div>
    </div>
    """, unsafe_allow_html=True)
    
    # Add spacing between drag area and browse button
    st.markdown('<div style="height: 40px;"></div>', unsafe_allow_html=True)
    
    # File uploader with custom styling
    st.markdown("""
    <div style="text-align: center; margin-bottom: 20px;">
        <h3 style="color: white; margin-bottom: 15px;">OR</h3>
    </div>
    """, unsafe_allow_html=True)
    
    # File uploader with custom container
    st.markdown('<div style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 15px; margin: 20px 0;">', unsafe_allow_html=True)
    ...
    # Add info box below the uploader
    if uploaded_file is None:
        st.markdown("""
        <div style="background: linear-gradient(135deg, rgba(6,214,160,0.1), rgba(102,126,234,0.1)); 
                    padding: 15px; 
                    border-radius: 10px; 
                    margin-top: 30px;
            ...
            <div style="display: flex; align-items: center; gap: 10px;">
                <div style="font-size: 1.5em;">💡</div>
                <div>
                    <strong>Supported Formats:</strong> WAV, MP3, M4A, FLAC<br>
                    <strong>Max Size:</strong> 200MB<br>
                    <strong>Recommended:</strong> Clear audio for best results
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
...
with col2:
    # Add spacing before the stats panel
    st.markdown('<div class="spacing-top"></div>', unsafe_allow_html=True)
    ...
    for key, value in stats_data.items():
        ...
        with col_a:
            st.markdown(f"**{key}**")
        with col_b:
            st.markdown(f"<span style='color: #FFD166; font-weight: bold;'>{value}</span>", unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="background: linear-gradient(135deg, rgba(255,107,107,0.1), rgba(255,209,102,0.1)); 
                padding: 20px; 
                border-radius: 15px; 
                margin-top: 20px;">
        <h4 style="color: white; margin-bottom: 15px;">✨ Key Features</h4>
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
            <div style="color: #06D6A0; font-size: 1.2em;">✓</div>
            <span style="color: rgba(255,255,255,0.9);">Hybrid AI Model</span>
        </div>
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
            <div style="color: #06D6A0; font-size: 1.2em;">✓</div>
            <span style="color: rgba(255,255,255,0.9);">Detailed Analytics</span>
        </div>
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
            <div style="color: #06D6A0; font-size: 1.2em;">✓</div>
            <span style="color: rgba(255,255,255,0.9);">Multiple Export Formats</span>
        </div>
        <div style="display: flex; align-items: center; gap: 10px;">
            <div style="color: #06D6A0; font-size: 1.2em;">✓</div>
            <span style="color: rgba(255,255,255,0.9);">Interactive Visualizations</span>
        </div>
    </div>
    """, unsafe_allow_html=True)

# Add horizontal line with spacing
st.markdown('<div class="spacing-large"></div>', unsafe_allow_html=True)
st.markdown('<hr style="border: 1px solid rgba(255,255,255,0.1);">', unsafe_allow_html=True)
st.markdown('<div class="spacing-large"></div>', unsafe_allow_html=True)

# Main analysis section (only shown when file is uploaded)
if uploaded_file is not None:
    ...
    for i in range(100):
        ...
        # Change status text every 20%
        stage_index = min(i // 20, len(stages) - 1)
        status_text.text(f"{stages[stage_index]} {i+1}%")
        time.sleep(0.01)
    ...
    try:
        ...
        # Display metrics in beautiful cards with spacing
        st.markdown('<div class="spacing-top"></div>', unsafe_allow_html=True)
    ...
    # Beautiful empty state with better spacing
    st.markdown('<div class="spacing-large"></div>', unsafe_allow_html=True)
    st.markdown("""
...
# Footer with gradient and spacing
st.markdown('<div class="spacing-large"></div>', unsafe_allow_html=True)
st.markdown("""
